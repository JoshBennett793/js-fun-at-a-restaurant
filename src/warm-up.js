...
if (stockCount >= 1) {
  console.log(`I'm going to ear some ${food}`);
} else {
...
var vegetables = ['carrots', 'onions', 'celery', 'spinach', 'broccoli'];
...
// We could add the hours, items in stock, number of checkout stations, and address as key value pairs.
